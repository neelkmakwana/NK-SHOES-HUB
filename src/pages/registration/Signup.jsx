...
const Signup = () => {
    ...
    return (
        <div className="bg-cyan-100" style={{ height: "100vh", overflow: "hidden" }}>
            <Navbar/>
        <div className='flex justify-center items-center h-screen' style={{ backgroundImage: `url('#')`, backgroundSize: 'full', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
            {/* Loader Component */}
            ...
            <img src="https://firebasestorage.googleapis.com/v0/b/myecom-be317.appspot.com/o/logo-transparent-png.png?alt=media&token=579951d1-e259-4b25-8e29-0aab7f581b7b" alt="NK-SHOES HUB Logo" className="mx-auto" style={{ width: '300px', height: '50px' }} />
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        if (e.target.value === '' || onlyLetters.test(e.target.value)) {
                            setUserSignup({
                                ...userSignup,
                                name: e.target.value
                            });
                ...
                <div>
                    <h2 className='text-black'>Have an account? <Link className=' text-indigo-600  font-bold' to={'/login'}>Login</Link></h2>
                </div>
