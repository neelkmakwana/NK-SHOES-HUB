...
const filterSearchData = getAllProduct
  ...
  return (
    ...
    <div className="flex items-center bg-gray-200 rounded-lg px-1 py-1 w-96 lg:w-96 md:w-96">
    <div className="px-2">
        ...
        <input
            type="text"
            placeholder="Search Footwear Here"
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="bg-gray-200 placeholder-gray-600 rounded-lg px-2 py-2 outline-none text-black"
