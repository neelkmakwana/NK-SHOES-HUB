...
const Navbar = () => {
    ...
    return (
        <nav className="bg-indigo-600 sticky top-0 rounded">
            <div className="lg:flex lg:justify-between items-center py-3 lg:px-3">
                <div className="left py-3 lg:py-0 pl-15">
                    <Link to={'/'}>
                    <img src="https://firebasestorage.googleapis.com/v0/b/myecom-be317.appspot.com/o/logo-transparent-png.png?alt=media&token=579951d1-e259-4b25-8e29-0aab7f581b7b" alt="NK-SHOES HUB Logo" className="mx-auto" style={{ width: '300px', height: '50px', filter: 'brightness(0) invert(1)' }} />
                    </Link>
                </div>
                ...
                <div className={`right lg:flex justify-center mb-4 lg:mb-0 ${isOpen ? 'block' : 'hidden'}`} style={{ fontSize: '18px', fontWeight: 'bold' }}>
                    <ul className="lg:flex lg:space-x-3 text-white font-medium text-md px-10" style={{ gap: '1rem' }}>
                        {/* Menu items */}
                        {/* Home */}
                        <li>
                            <Link to={'/'}>
                        ...
                        <li>
                            <Link to={'/allproduct'}>
                            <i class="fa-brands fa-elementor mr-1"></i>All Product
                            </Link>
                        </li>
